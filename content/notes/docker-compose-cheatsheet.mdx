...
description: "services: web: build: . # build from Dockerfile context: ./Path dockerfile: Dockerfile ports: - \"5000:5000\" volumes: - .:/code redis: image: redis ```"
date: 2021-02-22
slug: docker-compose-cheatsheet
topics: [notes]
originalUrl: "https://gist.github.com/bemijonathan/f430b630d438e497ca482be3ebccd34a"
---
---
title: Docker Compose Cheatsheet
